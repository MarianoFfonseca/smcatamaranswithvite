...
const FirstYachtPage = () => {
  return (
    <div id="FirstYachtPage" className="TheContainerSingleYacht">
      ...
      <div className="pt-32 text-white grid w-full h-[100vh] content-start items-center px-4">
        <div className="">
          ...
          <p>
            ...
            nihil dolores debitis veritatis autem repellat? Optio, eum modi,
            dolorem voluptate delectus exercitationem dicta quo vero ullam
            eveniet assumenda doloribus?
          </p>
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Animi enim
            nihil dolores debitis veritatis autem repellat? Optio, eum modi,
