...
import VideoHd from "../Images/VideoHdCompressed.mp4";
...
import SecondDetails from "./JSON/SecondDetails.json";
  ...
  return (
    <div className="TheContainer bg-black relative ">
      ...
      <div className="grid w-full h-1/2 md:grid-flow-col grid-flow-row md:grid-cols-2 overflow-hidden">
        <ShadowEffect text="Fast" span={1} Render={Render3} />
        <ShadowEffect text="Beautiful" span={2} Render={Render4} />
      </div>
    </div>
  );
};
